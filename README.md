...
<header>
      <img src="Logo.png" alt="Descripción" width="200" height="200">
...
<section class="section">
    ...
    <div class="services">
        <details class="card">
            <summary>Desarrollo de software a medida</summary>
            <p>Soluciones personalizadas para empresas.</p>
        </details>

        <details class="card">
            <summary>Aplicaciones móviles</summary>
            <p>Apps para Android y iOS.</p>
        </details>

        <details class="card">
            <summary>Aplicaciones web</summary>
            <p>Sitios y sistemas web modernos.</p>
        </details>

        <details class="card">
            <summary>Automatización de procesos</summary>
            <p>Optimización de tareas repetitivas.</p>
        </details>

        <details class="card">
            <summary>Integración de sistemas</summary>
            <p>Conectamos plataformas y servicios.</p>
        </details>

        <details class="card">
            <summary>Soporte y mantenimiento</summary>
            <p>Actualizaciones y soporte técnico.</p>
        </details>
